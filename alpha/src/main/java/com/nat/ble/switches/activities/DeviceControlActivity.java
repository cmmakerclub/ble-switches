...
import com.nat.ble.switches.interfaces.OnFragmentInteractionListener;
import com.nat.ble.switches.services.BluetoothLeService;
...
//                checked ? text+ " Checked!" : text+ "Unchecked!", Toast.LENGTH_SHORT).show();
    }
